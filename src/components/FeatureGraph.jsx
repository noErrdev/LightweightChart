        ...
        <>
        {
            ...
            <Chart {...options} >
                <AreaSeries
                    ...
                    lineWidth={2}
                />
                {data?<div className="absolute top-3 left-5 flex items-center justify-center z-10">
                    {countL10(data).icon == 'none' ? ' ':<img src= {`${countL10(data) ? countL10(data).icon : ' '}`} width={56} height={56} alt=' ' ></img>}
                </div>: null}
            </Chart> : null
        }
        </>
